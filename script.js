...
function getDeleteFeedId() {
  let value = localStorage.getItem(DELETE_FEED);
  if (value) {
...
function setDeleteFeed(value) {
  localStorage.setItem(DELETE_FEED, value);
}
  ...
  for (let feedKey of Object.keys(feeds)) {
                            ...
                            : `
                                <div>
                                    <img src="https://d2beiqkhq929f0.cloudfront.net/public_assets/assets/000/064/026/original/comment.png?1706888619"
                                        alt="comment" onclick="handleComment(${
                                          feed.key
                                        })">
                                    <img src="${likeImgLinkByValue(feed.like)}"
                                        alt="heart" onclick="handleLike(${
                                          feed.key
                                        })">
                                </div>
                                `
    ...
    for (let commentKey of feed.comments) {
      ...
      componentHtml += `
                    ...
                    <div style="flex-grow: 1;">
                        <div class="flex space-between">
                            <div><strong>${comment["name"]}</strong> <span>@${
                              comment["handle"]
                            }</span></div>
                            <div><img
                                    src="https://d2beiqkhq929f0.cloudfront.net/public_assets/assets/000/064/028/original/edit.png?1706888661"
                        ...
                        <textarea ${
                          comment.key === editFeedId ? "" : "readonly"
